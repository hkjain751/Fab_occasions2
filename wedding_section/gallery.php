...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-left: 60px;margin-right: 60px;">
            <div class="row mb-1">
                <div class="col gallery-btn-div" style="background-color: transparent;" id="gallery-btn1" onclick="gallery_section1()">Button-1</div>

                <div class="col gallery-btn-div" style="background-color: transparent;" id="gallery-btn2" onclick="gallery_section2()">Button-2</div>

                <div class="col gallery-btn-div" style="background-color: white;" id="gallery-btn2" onclick="gallery_section3()">Button-3</div>
