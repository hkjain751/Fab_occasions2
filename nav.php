                    ...
                    <nav class="menu menu--cordelia">
                        <ul class="menu__list">
                            <li class="menu__item menu__item--current">
                                <a href="#" class="menu--link a-color-white">Home</a>
                            </li>
                            <li class="menu__item">
							<!-- menu--link -->
                                <a href="wedding_section/w_section.php" class="menu--link a-color-white" onclick="<?php onClickRed('wedding_section/w_section.php') ?>">Weddings</a>
                            </li>
                            <li class="menu__item">
                                <a href="pre-weddings/" class="menu--link a-color-white">Pre-Weddings</a>
                            </li>
                            <li class="menu__item">
                                <a href="#" class="menu--link a-color-white">Vendors</a>
                            </li>
                            <li class="menu__item">
                                <a href="#" class="menu--link a-color-white">Blog</a>
                            </li>
                            <li class="menu__item">
                                <a href="#" class="menu--link a-color-white">Contact</a>
                            </li>
                            <div class="d-inline-block p-0 pr-2 pl-2 navbar-Options border-0 text-white" id="more" style="margin-top: 2.28em; font-size: 18px;">More&nbsp;
                                <div class="more-list " style="border-radius: 1.2em; left: 65% !important; max-width: 200px !important; top: 55px;">
                                    <ul class="p-2 text-center" style="list-style-type: none; border-radius: 1.2em; ">
                                        <li class="p-2 a-color-white">About</li>
                                        <li class="p-2 a-color-white">Anniversaries</li>
                                        <li class="p-2 a-color-white text-white">Birthdays</li>
                                        ...
                                        <li class="p-2 a-color-white">FAQs</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <li class="menu__item" id="account-button" style="padding: 18px 60px 0px 60px;line-height: auto;">
                                <a href="#" class="a-color-white" style="padding: 0px;height: 33px !important;">
                                    <i class="fa fa-user"></i>&nbsp;&nbsp;Account Section</a>
									<!-- Manan -->
                            </li>
                        </ul>
                    </nav>
