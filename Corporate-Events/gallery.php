...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-left: 60px;margin-right: 60px;">
            <div class="row mb-1">
                <div class="col gallery-btn-div" style="box-shadow: 0 0 0 0;background-color: transparent;border-width: 2px; border-style: solid; border-color: black;" id="gallery-btn1" onclick="gallery_section1()">Button-1</div>

                <div class="col gallery-btn-div" style="box-shadow: 0 0 0 0;background-color: transparent;border-width: 2px; border-style: solid; border-color: black;" id="gallery-btn2" onclick="gallery_section2()">Button-2</div>

                <div class="col gallery-btn-div" style="box-shadow: 0 0 0 0;background-color: transparent;border-width: 2px; border-style: solid; border-color: black;" id="gallery-btn2" onclick="gallery_section3()">Button-3</div>
