...
?>
    ...
    <head>
        ...
        <style>
            ...
            .s4_container {
                ...
                background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("resources/img/img_5.jpg") center no-repeat;
    ...
    <body>
        ...
        <!-- Main Content -->
        <div class="container-fluid" style="height: 800px; background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('resources/img/img_3.jpg') center no-repeat; background-attachment: fixed; background-size: cover; border-bottom: solid 5px red;">
            ...
            <div class="container-fluid bg-white position-relative rounded p-0" style="top: 400px; width: 90%; box-shadow: 0 0 3px 2px rgba(0, 0, 0, 0.1);">
                ...
                <div class="container font-Overlock text-center mb-3 mt-3">
                    <div class="jumbotron-fluid">
                        <div style="font-size: 35px;">
                            <span style="color: rgb(244, 72, 58);">&mdash;</span> Dynamic
                            <span style="color: rgb(244, 72, 58);">Corporate</span>&nbsp;Events&nbsp;<span style="color: rgb(244, 72, 58);">&mdash;</span>
                        </div> <br>
                        <h1 class="border-bottom p-1" style=" font-family: Cambria; border-bottom-color: #818181 !important;">
                            What's Your Next Corporate Events
                        </h1>
                        <h5 style="font-family: Cambria;">Just Send Us The Requirements & Fab Takes Care of Rest</h5>
                    </div>
                </div>
                ...
                <div class="container p-3 pre-wedding-events-section font-Overlock" style="width: 100% !important;">
                    <div class="row">
                        <div class="standard-height-1 pre-wedding-events-option col-4 p-0">
                            <div class="pre-wedding-event-option-text d-flex" style="background-size: cover !important; background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url('resources/img/img_6.jpg') center no-repeat;">
                                <table class="text-center w-100 h-100 text-white">
                                    <tr>
                                        <td class="p-2">
                                            <h3>
                                                <span id="bottom_line" style="color: white; text-align: center; ">
                                            Conference	
										</span></h3>
                                        </td>
                                    </tr>
                        ...
                        <div class="standard-height-1 col-4 pre-wedding-events-option p-0">
                            <div class="pre-wedding-event-option-text d-flex" style="background-size: cover !important; background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)),url('resources/img/img_2.jpg') center no-repeat; background-size: 150%;">
                                <table class="text-center w-100 h-100 text-white">
                                    <tr>
                                        <td class="p-2">
                                            <h3>
                                                <span id="bottom_line" style="color: white; text-align: center; ">Seminar</span>
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="standard-height-1 col-4 pre-wedding-events-option p-0">
                            <div class="pre-wedding-event-option-text d-flex" style="background-size: cover !important; background-size: cover; background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)),url('resources/img/img_4.jpg') center no-repeat;">
                                <table class="text-center w-100 h-100 text-white">
                                    <tr>
                                        <td class="p-2">
                                            <h3>
                                                <span id="bottom_line" style="color: white; text-align: center;">Exhibitions</span>
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="row">
                        <div class="standard-height-1 pre-wedding-events-option col-4 p-0">
                            <div class="pre-wedding-event-option-text d-flex" style="background-size: cover !important; background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)),url('resources/img/img_2.jpg') center no-repeat;">
                                <table class="text-center w-100 h-100 text-white">
                                    <tr>
                                        <td class="p-2">
                                            <h3>
                                                <span id="bottom_line" style="color: white; text-align: center;">Business Meetings</span>
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="standard-height-1 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12 d-flex pre-wedding-events-option p-0">
                            <div class="pre-wedding-event-option-text d-flex" style="background-size: cover !important; background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)),url('resources/img/img_7.jpg') center no-repeat;">
                                <table class="text-center h-100 text-white">
                                    <tr>
                                        <td class="p-2">
                                            <h3>
                                                <span id="bottom_line" style="color: white;  text-align: center;">Trade Show</span>
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="standard-height-1 col-4 pre-wedding-events-option p-0">
                            <div class="pre-wedding-event-option-text d-flex" style="background-size: cover !important; background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)),url('resources/img/img_5.jpg') center no-repeat;">
                                <table class="text-center w-100  h-100 text-white">
                                    <tr>
                                        <td class="p-2">
                                            <h3>
                                                <span id="bottom_line" style="color: white; text-align: center;">Hi &mdash; Tea Party</span>
                                            </h3>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div class="container-fluid pre-wedding-special-services text-center p-0">
                    <div class="container-fluid">
                        <div class="jumbotron bg-transparent m-0 font-Overlock">
                            <h1 class="p-1 font-Overlock" style="">
                                <span class="text-danger">&mdash;</span> Fab&nbsp;<span class="text-danger">Corporate&nbsp;</span>Services
                                <span class="text-danger">&mdash;</span>
                            </h1>
                            <hr noshade style="boder-width: 1px;">
                        </div>
                    </div>
                    <!-- search bar from home s4 -->
                    <div class="container-fluid p-0" data-parallax="scroll" data-image-src="resources/img/img_5.jpg">
                        <div class="s4_container">
                            ...
                            <div class="container s4-padding-m bg-transparent" style="width: 40%;">
                                <div class="input-group border-0">
                                    ...
                                    <input type="text" class="s4-search-bar-end form-control border-0 s4-font-size-search-bar s4-no-box-shadow s4-search-bar" placeholder="Search Here..." id="s4-search-text-box">
                    ...
                    <div class="pre-wedding-services-options container-fluid pb-2 font-Overlock">
                        <div class="container mt-5 mb-2">
                            <div class="row text-white">
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_1.jpg') center no-repeat; background: cover;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Private Cabins
										</h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_1.jpg') center no-repeat; backfroung: cover !important;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Co-working Space
										</h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background: cover !important; background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_2.jpg') center no-repeat;">
                                    <span class="w-100 align-self-end">
										<h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_4.jpg') center no-repeat;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Jwellery
										</h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_5.jpg') center no-repeat;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Make Up Artists
										</h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_6.jpg') center no-repeat;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Invitations
										</h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_7.jpg') center no-repeat;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Groom Wear
										</h3>
                                ...
                                <div class="fab-services-options col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-12 standard-height-1 d-flex" style="background:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) ,url('./resources/img/img_2.jpg') center no-repeat;">
                                    <span class="w-100 align-self-end">
										<h3 class="text-white font-Overlock">
											Accessories
										</h3>
                ...
                <div class="uk-block uk-block-default">
                    <div style="background:linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)), url(./resources/img/backkitty.jpg);height: 400px;width:100%;background-size: cover;">
                        ...
                        <h4 style="color: #fff; text-align: center; margin-left: 15%; margin-right: 15%; font-family: 'Overlock', cursive;">FAB Experience makes it very easy for you altogether, just sit back & relax and leave it to FAB. Just search for the best services and enjoy personal assistance from FAB in all your events</h4>
